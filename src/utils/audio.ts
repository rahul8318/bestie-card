...
export class SoundSynthesizer {
  ...
  // A beautiful friendship chord progression in Fmaj7 - G6 - Am7 - Em7 (Keys that feel warm and joyful)
  private melodyNotes = [
    // Fmaj7 (F, A, C, E)
  ...
  startBackgroundMusic() {
    ...
    // Play a note every 0.8 seconds in a warm arpeggiated friendship pattern
    this.bgmStep = 0;
